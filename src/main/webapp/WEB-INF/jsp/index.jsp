					...
					<div>
						<div>
							<div class="filtre_cat">
								...
								<div class="btn">
									<input class="btn_rechercher" type="submit" name="rechercher"
										value="Rechercher"> <br /> 
								</div>
							</div>
						</div>
			...
			<div class="col">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">PC Gamer PC monté par un professionnel il
							y a 2 ans, très bon état, remis à neuf avec alimentation neuve.
							On peut fournir les boîtes de la plupart des composants,
							(alimentation, qui est sous-garantie</p>
			...
			<div class="col">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">table à manger style industriel plateau
							bois foncé et pieds métal - Longueur en 160 - rallonge de 50
							intégrée - Etat neuf achetée en juillet 2021</p>
			...
			<div class="col">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">JACK AND JONES Sweats à Capuche Miller
							Homme Bordeaux Couleur:Bordeaux / Bleu Marine / Blanc Précisions
							sur le produit:Logo imprimé. 60% coton 40% polyester. Capuche
							doublée avec cordon. Poignets et ourlet à côtes.</p>
			...
			<div class="col">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">Ballon de collection (football) - ancien
							Cuir vintage années 50-60.</p>
